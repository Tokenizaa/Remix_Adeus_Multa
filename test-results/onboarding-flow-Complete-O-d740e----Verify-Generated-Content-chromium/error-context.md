...
- Name: onboarding-flow.spec.ts >> Complete Onboarding Flow - 11 Steps >> Step 10: Document Review - Verify Generated Content
- Location: tests/e2e/onboarding-flow.spec.ts:120:3
...
Locator: locator('text=Revisão da Peça Jurídica')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Revisão da Peça Jurídica')
