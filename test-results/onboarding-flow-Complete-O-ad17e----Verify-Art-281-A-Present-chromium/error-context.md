...
- Name: onboarding-flow.spec.ts >> Complete Onboarding Flow - 11 Steps >> Step 8: Free Analysis Result - Verify Art. 281-A Present
- Location: tests/e2e/onboarding-flow.spec.ts:83:3
...
Locator: locator('text=Diagnóstico Jurídico Concluído')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Diagnóstico Jurídico Concluído')
