...
- Name: onboarding-flow.spec.ts >> Complete Onboarding Flow - 11 Steps >> Step 9: Required Data - Fill Applicant Data
- Location: tests/e2e/onboarding-flow.spec.ts:99:3
...
Locator: locator('text=Qualificação do Requerente')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Qualificação do Requerente')
