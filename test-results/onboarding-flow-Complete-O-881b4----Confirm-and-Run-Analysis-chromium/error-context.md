...
- Name: onboarding-flow.spec.ts >> Complete Onboarding Flow - 11 Steps >> Step 6: Data Confirmation - Confirm and Run Analysis
- Location: tests/e2e/onboarding-flow.spec.ts:71:3
...
Locator: locator('text=Confirmação dos Dados')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Confirmação dos Dados')
