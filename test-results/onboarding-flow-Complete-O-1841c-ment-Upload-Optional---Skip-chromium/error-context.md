...
- Name: onboarding-flow.spec.ts >> Complete Onboarding Flow - 11 Steps >> Step 5: Document Upload (Optional) - Skip
- Location: tests/e2e/onboarding-flow.spec.ts:65:3
...
Locator: locator('text=Upload Opcional')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Upload Opcional')
