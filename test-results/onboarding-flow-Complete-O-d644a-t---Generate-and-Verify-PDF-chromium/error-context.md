...
- Name: onboarding-flow.spec.ts >> Complete Onboarding Flow - 11 Steps >> Step 11: Document Checkout - Generate and Verify PDF
- Location: tests/e2e/onboarding-flow.spec.ts:142:3
...
Locator: locator('text=Emissão da Petição')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Emissão da Petição')
