...
- Name: onboarding-flow.spec.ts >> Complete Onboarding Flow - 11 Steps >> Step 1: Service Selection - Defesa Prévia
- Location: tests/e2e/onboarding-flow.spec.ts:18:3
...
Locator: locator('text=Seleção do Procedimento')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Seleção do Procedimento')
