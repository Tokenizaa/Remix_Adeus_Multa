...
- Name: onboarding-flow.spec.ts >> Complete Onboarding Flow - 11 Steps >> Step 2: Infraction Type - Radar
- Location: tests/e2e/onboarding-flow.spec.ts:24:3
...
Locator: locator('text=Tipo da Infração')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Tipo da Infração')
