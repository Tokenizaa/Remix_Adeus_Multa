...
- Name: onboarding-flow.spec.ts >> Complete Onboarding Flow - 11 Steps >> Step 3: Defense Stage - Defesa Prévia
- Location: tests/e2e/onboarding-flow.spec.ts:30:3
...
Locator: locator('text=Fase Processual')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=Fase Processual')
