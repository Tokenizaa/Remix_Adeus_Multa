    ...
    <div className="bg-[#071D41] text-white text-[11px] py-1.5 px-4 sm:px-6 lg:px-8 border-b border-[#0C326F]">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-3 font-medium overflow-x-auto py-0.5">
          <a
            href="#main-content"
            className="hover:underline flex items-center gap-1 focus:text-[#FFCD07] outline-none"
            title="Ir para o conteúdo principal (Alt + 1)"
          >
            <span>Ir para o conteúdo</span>
            <kbd className="hidden md:inline-block px-1.5 py-0.2 bg-[#0C326F] text-[9px] rounded font-mono border border-blue-900">
              1
            </kbd>
          </a>
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-1 bg-[#0C326F] rounded px-1.5 py-0.5 border border-blue-900">
            <button
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2 py-0.5 rounded border transition-colors cursor-pointer ${
              isHighContrast
                ...
                : 'bg-[#0C326F] hover:bg-[#155BCB] text-white border-blue-900'
            }`}
